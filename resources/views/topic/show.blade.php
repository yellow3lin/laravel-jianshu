...
@section('content')
        <div class="col-sm-8">
            <blockquote>
                ...
                <button class="btn btn-default topic-submit"  data-toggle="modal" data-target="#topic_submit_modal" topic-id="1" _token="{{csrf_token()}}" type="button">投稿</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/topic/{{$topic->id}}/submit">
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="post_id[]" value="{{$mypost->id}}">
                                    {{$mypost->title}}
                                </label>
                            </div>
                            @endforeach
